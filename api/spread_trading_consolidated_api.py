...
def spread_trading_consolidated():
	...
	for code in ScripCode:
		...
		additional_market_data['Average_Spread'] = additional_market_data['Spread'].rolling(period0).mean()
	...
	current_date=spread_trading_export['Datetime'].max()
	#print("Current Date :" + current_date)
	mask = (spread_trading_export['Datetime'] == current_date)
	spread_trading_export = spread_trading_export.loc[mask]
	spread_trading_export=spread_trading_export.drop_duplicates()
	spread_trading_export_df=spread_trading_export[['ScripName','Volume','Open','Close','Low','High','Spread','Average_Spread']]
	#spread_trading_export_df=spread_trading_export[['ScripName',,'Low','High','Spread','Average_Spread']]
	spread_trading_export_df=spread_trading_export_df.dropna()
	spread_trading_export_df=spread_trading_export_df.sort_values(by='Average_Spread',ascending=False)




	return spread_trading_export_df
